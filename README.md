...
3. Download the Windows file. It may end in `.exe` or be packed in a `.zip` file.
...
3. Re-download the release file if the download failed
4. Make sure the file fully finished downloading
